...
| **2026-07 flood extent is fragmentation-heavy** | 610 patches, median 1 px, only 64.9% of area in patches ≥10 px (vs 98.3% for the validated 2025-09 peak) — do not report 0.21% as a series peak | Quality masks are applied *after* the 7×7 median filter, carving holes in smoothed blobs and leaving remnants along slope/permanent-water edges; consider masking before smoothing |
